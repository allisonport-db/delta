...
public interface SnapshotReport extends DeltaOperationReport {
   ...
   * For a time-travel by timestamp query, this is the version resolved from the provided timestamp.
   * For a latest snapshot, this is the version read from the delta log.
   *
   * This is empty when this report is for a failed snapshot construction, and the error occurs
